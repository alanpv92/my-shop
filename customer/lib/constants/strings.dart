class TStrings {
  TStrings._();
  static String onboarding1Tittle = 'Choose from a variety of products';
  static String onboarding2Tittle = 'Delivery done quickly, fast and efficient';
  static String onboarding3Tittle = 'Speedy, hassle-free shopping for ease';
